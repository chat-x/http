...
class ControllerTests: TestCase {
    ...
    static var allTests = [
        ("testControllerInjectable", testControllerInjectable),
        ("testControllerInjectService", testControllerInjectService),
        ("testControllerInject2Services", testControllerInject2Services),
        ("testControllerInject3Services", testControllerInject3Services),
        ("testControllerInject4Services", testControllerInject4Services),
        ("testControllerInject5Services", testControllerInject5Services),
        ("testControllerInject6Services", testControllerInject6Services),
    ]
}
